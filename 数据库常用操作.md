...
<!-- 数据库备份操作 -->
mysqldump -u root -p mysql > /data/mysql_backup/mysql_1.sql
mysqldump -u root -p notebook > /data/mysql_backup/notebook_2.sql

<!-- 数据库恢复操作 -->
mysql -u root -p notebook < /data/mysql_backup/20250420020002.sql
<!-- 创建数据库notebook -->
